...
print('Random Forest:')
print('Random Forest - n_estimators: '%n_estimators_list)
print('Random Forest - max_depth: '% max_depth_list)
print('Random Forest - best combo: '%best_params_)
print('Random Forest - best n_estimator: '%grid.best_estimator_.n_estimators)
print('Random Forest - best max_depth: '%grid.best_estimator_.max_depth)

#### Get accuracy score now #########################################################################
#### Get accuracy score now #########################################################################
#### Get accuracy score now #########################################################################
#### Get accuracy score now #########################################################################
#### Get accuracy score now #########################################################################
...
print('SVM - Kernel Values tested: '% kernel_list)
print('SVM - C values tested: '% c_list)

print('SVM - best kernel: '%grid3.best_estimator_.kernel)
print('SVM - best C: '%grid3.best_estimator_.C)

##################################### Q 3.3 ###################################################################
########################################### Cross-Validation Results #################################################

print('Q 3.3')
#print('SVM - Highest mean testing/cv accuracy: '%accuracy_score(y_test, y_pred4_test_grid))
#print('SVM - Mean train score: '%accuracy_score(y_train, y_pred4_train_grid))
#print('SVM - Mean fit time: '%accuracy_score(y_train, y_pred4_train_grid))
...
print('Q 3.4')
print('Random Forest  - Most important feature (e.g. X5): ' % coef_sorted_list2[0])
print('Random Forest  - Least important feature (e.g. X1): ' % coef_sorted_list2[-1])
...
print('Singular values corresponding to each component: '%pca.singular_values_)